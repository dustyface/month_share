	...
	var weaveOne = function(source, method, advice) {
		...
		if (advice.type == _after || advice.type == _afterThrow || advice.type == _afterFinally)
			...
			aspect = function() {
				...
				//added by cangpeng
				//add the ability of not entering advice handler
				var _mid_retValue = advice.value.apply(this, [arguments, method]);
				
				//if any before inject handler returns false, 
				//the formal listener will not get executed.
				if ( false === _mid_retValue ){
					return 
				}
